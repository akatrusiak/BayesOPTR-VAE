     ...
     &8,QM19,QM20,QM21,QM22,QM23,QM24,QM25,QM26,Q
     &M27,QM28,QM29,QM30
...
!     &0.319679*RFA16,102.77,1.0608e+08,1.0*RFP8,'ISAC1:DTL5')
     ...
     &0.0043,2.6,18.2,wo,'HEBT:Q12')
      ...
      call mquad(-0.00029746*QM24,1.0,8.0,wo,'HEBT2:Q2')
      call drift(54.956,".")
      ...
      call mquad(-3.19953e-10*QM25**5.0 + 5.03293e-08*QM25**4.0 -
     &2.98602e-06*QM25**3.0 + 7.328e-05*QM25**2.0 + 0.0086354*QM25 +
     &0.0043,2.6,18.0,wo,'HEBT2:Q3')
      call drift(34.9997,".")
      ! Magnetic quadrupole HEBT2:Q4
      call mquad(3.19953e-10*QM26**5.0 - 5.03293e-08*QM26**4.0 +
     &2.98602e-06*QM26**3.0 - 7.328e-05*QM26**2.0 - 0.0086354*QM26 -
     &0.0043,2.6,18.0,wo,'HEBT2:Q4')
      ...
      call mquad(3.19953e-10*QM27**5.0 - 5.03293e-08*QM27**4.0 +
     &2.98602e-06*QM27**3.0 - 7.328e-05*QM27**2.0 - 0.0086354*QM27 -
     &0.0043,2.6,18.0,wo,'HEBT2:Q5')
      call drift(30.0004,".")
      ! Magnetic quadrupole HEBT2:Q6
      call mquad(-3.19953e-10*QM28**5.0 + 5.03293e-08*QM28**4.0 -
     &2.98602e-06*QM28**3.0 + 7.328e-05*QM28**2.0 + 0.0086354*QM28 +
     &0.0043,2.6,18.0,wo,'HEBT2:Q6')
      ...
      call mquad(3.19953e-10*QM29**5.0 - 5.03293e-08*QM29**4.0 +
     ...
     &0.0043,2.6,18.0,wo,'HEBT2:Q7')
      ...
      call mquad(3.19953e-10*QM30**5.0 - 5.03293e-08*QM30**4.0 +
     ...
     &0.0043,2.6,18.0,wo,'HEBT2:Q8')
      ...
      ! MCAT-verb: set-dragon-gas
      !nlines: 3
      !call twissmatch(1,0.,5.0*bdtl,50.,1)
      !call twissmatch(3,0.,5.0*bdtl,50.,1)
      !return
      ! Gas-Match
